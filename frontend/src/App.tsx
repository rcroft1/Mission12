...
// team class that builds out the cards
...
//SchoolList function gives oneTeam all three elements from the Team class
...
// this outputs both the welcome and the schoollist functions
